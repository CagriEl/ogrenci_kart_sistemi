<form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    @endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <label for="ogretmen_belge" class="form-label">Öğretmen Görev Yeri Belgesi (PDF)</label>
                                <input type="file" class="form-control" id="ogretmen_belge" name="ogretmen_belge" accept="application/pdf" required>
                            </div>
                        </div>
